...
q13_SucheProduktprivateJoined <- left_join(q13_SucheProduktprivateAngepasst,q23_Geschlecht, by = "Nummer")
q13_SucheProduktprivateJoined <- left_join(q13_SucheProduktprivateJoined, q24_Alter, by = "Nummer")
...
q13_SucheProduktprivateJoined %>% ggplot(aes(x=Frequenz, fill= Quelle)) + geom_bar(position = "dodge2") + xlab("Quelle") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q13_SucheProduktfirmJoined <- left_join(q13_SucheProduktfirmAngepasst,q23_Geschlecht, by = "Nummer")
q13_SucheProduktfirmJoined <- left_join(q13_SucheProduktfirmJoined, q24_Alter, by = "Nummer")
...
q13_SucheProduktfirmJoined %>% ggplot(aes(x=Frequenz, fill= Quelle)) + geom_bar(position = "dodge2") + xlab("Quelle") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q14_VertrauenJoined %>% ggplot(aes(x=Frequenz, fill= Quelle)) + geom_bar(position = "dodge2") + xlab("") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q15_EmailNewsletterprivatJoined <- left_join(q15_EmailNewsletter,q23_Geschlecht, by = "Nummer")
q15_EmailNewsletterprivatJoined <- left_join(q15_EmailNewsletterprivatJoined, q24_Alter, by = "Nummer")
...
q15_EmailNewsletterprivatJoined %>% ggplot(aes(x=Frequenz, fill= Grund)) + geom_bar(position = "dodge2") + xlab("") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()

q15_EmailNewsletterprivatJoined %>% ggplot(aes(x=Frequenz, fill= Grund)) + geom_bar(position = "dodge2") + xlab("") + ylab("Anzahl") + facet_wrap(.~GeschlechtText)  + coord_flip()
...
q16_NichtAbonniertAngepasst$Frequenz <- factor(q16_NichtAbonniertAngepasst$Frequenz, levels = levels)




q16_NichtAbonniertJoined <- left_join(q16_NichtAbonniertAngepasst,q23_Geschlecht, by = "Nummer")
q16_NichtAbonniertJoined <- left_join(q16_NichtAbonniertJoined, q24_Alter, by = "Nummer")
...
q_frequenz <- getfrequenz(subset(q16_NichtAbonniert, select = columnNames1),2,levels(q16_NichtAbonniertAngepasst$Art), levels, c(1:2), TRUE)

knitr::kable(
  q_frequenz, longtable = TRUE, booktabs = TRUE
)

q16_NichtAbonniertJoined %>% ggplot(aes(x=Frequenz, fill= Art)) + geom_bar(position = "dodge2") + xlab("") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q17_BevorzugteKommunikationJoined <- left_join(q17_BevorzugteKommunikationAngepasst,q23_Geschlecht, by = "Nummer")
q17_BevorzugteKommunikationJoined <- left_join(q17_BevorzugteKommunikationJoined, q24_Alter, by = "Nummer")

q17_BevorzugteKommunikationJoined %>% ggplot(aes(x=Medium)) + geom_bar(fill=colorSingleBar) + xlab("Medium") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q18_QuellenSucheJoined <- left_join(q18_QuellenSucheAngepasst,q23_Geschlecht, by = "Nummer")
q18_QuellenSucheJoined <- left_join(q18_QuellenSucheJoined, q24_Alter, by = "Nummer")
...
q18_QuellenSucheJoined %>% ggplot(aes(x=Frequenz, fill= Quelle)) + geom_bar(position = "dodge2") + xlab("Quelle") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q19_QuellenKaufJoined <- left_join(q19_QuellenKaufAngepasst,q23_Geschlecht, by = "Nummer")
q19_QuellenKaufJoined <- left_join(q19_QuellenKaufJoined, q24_Alter, by = "Nummer")
...
q19_QuellenKaufJoined %>% ggplot(aes(x=Frequenz, fill= Quelle)) + geom_bar(position = "dodge2") + xlab("") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
levels = c("Text(Artikel, Newsletter)", "Bilder / Grafiken / Fotos", "Audio (Podcasts usw.)","Video","Andere")
...
q20_MediumAktuellJoined <- left_join(q20_MediumAktuellAngepasst,q23_Geschlecht, by = "Nummer")
q20_MediumAktuellJoined <- left_join(q20_MediumAktuellJoined, q24_Alter, by = "Nummer")

q20_MediumAktuellJoined %>% ggplot(aes(x=Medium)) + geom_bar(fill=colorSingleBar) + xlab("Prozent") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q21_MediumZukunftJoined <- left_join(q21_MediumZukunftAngepasst,q23_Geschlecht, by = "Nummer")
q21_MediumZukunftJoined <- left_join(q21_MediumZukunftJoined, q24_Alter, by = "Nummer")

q21_MediumZukunftJoined %>% ggplot(aes(x=Medium)) + geom_bar(fill=colorSingleBar) + xlab("Prozent") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
...
q22_MediumVorteilJoined <- left_join(q22_MediumVorteilAngepasst,q23_Geschlecht, by = "Nummer")
q22_MediumVorteilJoined <- left_join(q22_MediumVorteilJoined, q24_Alter, by = "Nummer")

q22_MediumVorteilJoined %>% ggplot(aes(x=Medium)) + geom_bar(fill=colorSingleBar) + xlab("Medium") + ylab("Anzahl") + facet_wrap(.~AlterText)  + coord_flip()
