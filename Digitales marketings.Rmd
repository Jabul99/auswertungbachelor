...
getfrequenzAlter <- function(x, Rowfactors, ColumnNames, TotalAnzeigen){
  ...
  numberoflevels2 <- numberoflevels * 6
  items <- c(1:numberoflevels2)
  ...
  for(numberofCurrentColumn in itemsoflevels){
    ...
    for(val in items)
    {
      if(!is.na(numbers[val,1]))
      {
        columnnumber <- as.numeric(numbers[val,1]) +3
        rownumber <- 0
        if(as.numeric(numbers[val,2]) == 7 )
        {
          rownumber <- correctRow + 5
          resultDataframe[rownumber,columnnumber] <- paste(if_else(TotalAnzeigen, 
                                                                   paste(as.character(numbers[val,9]),"% ", sep =""), ""), "(",as.character(numbers[val,3]), ")", sep ="")
          summeItems65 <- summeItems65 + as.numeric(numbers[val,3])
        }
        else if(as.numeric(numbers[val,2]) == 6)
        { 
          rownumber <- correctRow + 4
          resultDataframe[rownumber,columnnumber] <- paste(if_else(TotalAnzeigen, 
                                                                   paste(as.character(numbers[val,8]),"% ", sep =""), ""), "(",as.character(numbers[val,3]), ")", sep ="")
          summeItems56 <- summeItems56 + as.numeric(numbers[val,3])
        }
        else if(as.numeric(numbers[val,2]) == 5)
        { 
          rownumber <- correctRow + 3
          resultDataframe[rownumber,columnnumber] <- paste(if_else(TotalAnzeigen, 
                                                                   paste(as.character(numbers[val,7]),"% ", sep =""), ""), "(",as.character(numbers[val,3]), ")", sep ="")
          summeItems41 <- summeItems41 + as.numeric(numbers[val,3])
        }
        else if(as.numeric(numbers[val,2]) == 4)
        { 
          rownumber <- correctRow + 2
          resultDataframe[rownumber,columnnumber] <- paste(if_else(TotalAnzeigen, 
                                                                   paste(as.character(numbers[val,6]),"% ", sep =""), ""), "(",as.character(numbers[val,3]), ")", sep ="")
          summeItems33 <- summeItems33 + as.numeric(numbers[val,3])
        }
        else if(as.numeric(numbers[val,2]) == 3)
        { 
          rownumber <- correctRow + 1
          resultDataframe[rownumber,columnnumber] <- paste(if_else(TotalAnzeigen, 
                                                                   paste(as.character(numbers[val,5]),"% ", sep =""), ""), "(",as.character(numbers[val,3]), ")", sep ="")
          summeItems26 <- summeItems26 + as.numeric(numbers[val,3])
        }
        else if(as.numeric(numbers[val,2]) == 2)
        { 
          rownumber <- correctRow
          resultDataframe[rownumber,columnnumber] <- paste(if_else(TotalAnzeigen, 
                                                                   paste(as.character(numbers[val,4]),"% ", sep =""), ""), "(",as.character(numbers[val,3]), ")", sep ="")
          summeItems18 <- summeItems18 + as.numeric(numbers[val,3])
        }
      ...
      if(TotalAnzeigen){
        ...
        resultDataframe[correctRow+4,numberofColumnNames +4] <- summeItems56
...
q1_frequenz <- getfrequenz(subset(q1_Suchmaschine, select = c(google, bing, yahoo, search.ch, escosia.org, Andere)),5,levels(q1_SuchmaschineJoined$Suchmaschine), levels2, c(1:6), TRUE)

knitr::kable(
  q1_frequenz, longtable = TRUE, booktabs = TRUE
)

frequenzfactors <- factor(c("google", "bing", "yahoo", "search.ch", "esosia.org", "Andere"))
...
q1_frequenzalter<- getfrequenzAlter(q1_SuchmaschineJoinedAlter, frequenzfactors, levels2, TRUE)
...
q1_frequenzgeschlecht <- getfrequenzgeschlecht(q1_SuchmaschineJoinedGeschlecht,frequenzfactors,levels2, TRUE)
...
q6_frequenz <- getfrequenz(subset(q6_VewendungSozialMedia, select = c(Facebook, Instagram, YouTube, Twitter, LinkedIn, Snapchat, TikTok, Andere)),5,levels(q6_VewendungSozialMediaAngepasst$SocialMedia), levels2, c(1:8), TRUE)
...
frequenzfactors <- factor(c("Facebook", "Instagram", "YouTube", "Twitter", "LinkedIn", "Snapchat", "TikTok", "Andere"))
...
q_frequenzalter<- getfrequenzAlter(q6_VewendungSozialMediaAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q6_VewendungSozialMediaGeschlecht,frequenzfactors,levels2, TRUE)
...
q7_frequenz <- getfrequenz(subset(q7_SucheProduktSozialMedia, select = c(privat, geschäftlich)),5,levels(q7_SucheProduktSozialMediaAngepasst$Art),levels2, c(1:2), TRUE)
...
q_frequenzalter<- getfrequenzAlter(q8_KommunikationUnternehmenJoinedAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q8_KommunikationUnternehmenGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q9_KommunikationUnternehmenhaufigJoinedAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q9_KommunikationUnternehmenhaufigGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q10_UnternehmeneinkaufJoinedAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q10_UnternehmeneinkaufGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q11_UnternehmeneinkaufKonkurrenzAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q11_UnternehmeneinkaufKonkurrenzGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q12_likseinkaufAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q12_likseinkaufGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q13_SucheProduktprivateAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q13_SucheProduktprivateGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q13_SucheProduktfirmAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q13_SucheProduktfirmGeschlecht,frequenzfactors,levels2, TRUE)
...
levels2kurz = c("nicht vertr.", "wenig vertr.", "mittelmässig vertr.","ziemlich vertr.","sehr vertr.")
levels = addNA(levels2)
...
),5,levels(q14_VertrauenAngepasst$Quelle), levels2kurz, c(1:8), TRUE)
...
q_frequenzalter<- getfrequenzAlter(q14_VertrauenAlter, frequenzfactors, levels2kurz, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q14_VertrauenGeschlecht,frequenzfactors,levels2kurz, TRUE)
...
# q15_EmailNewsletterAlter <- JoinTableAlter(q15_EmailNewsletter)
# 
# q_frequenzalter<- getfrequenzAlter(q15_EmailNewsletterAlter, frequenzfactors, levels2, TRUE)
# 
# knitr::kable(
#   q_frequenzalter, longtable = TRUE, booktabs = TRUE
# )
...
# q15_EmailNewsletterGeschlecht <- JoinTableGeschlecht(q15_EmailNewsletter)
# 
# q_frequenzgeschlecht <- getfrequenzgeschlecht(q15_EmailNewsletterGeschlecht,frequenzfactors,levels2, TRUE)
# 
# knitr::kable(
#   q_frequenzgeschlecht, longtable = TRUE, booktabs = TRUE
# )
...
q_frequenzalter<- getfrequenzAlter(q16_NichtAbonniertAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q16_NichtAbonniertGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q18_QuellenSucheAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q18_QuellenSucheGeschlecht,frequenzfactors,levels2, TRUE)
...
q_frequenzalter<- getfrequenzAlter(q19_QuellenKaufAlter, frequenzfactors, levels2, TRUE)
...
q_frequenzgeschlecht <- getfrequenzgeschlecht(q19_QuellenKaufGeschlecht,frequenzfactors,levels2, TRUE)
...
q20_MediumAktuellJoinedGeschlecht <- JoinTableGeschlecht(q20_MediumAktuell)
...
q20_MediumAktuellJoinedAlter <- JoinTableAlter(q20_MediumAktuell)
...
q21_MediumZukunftJoinedGeschlecht <- JoinTableGeschlecht(q21_MediumZukunft)
...
q21_MediumZukunftJoinedAlter <- JoinTableAlter(q21_MediumZukunft)
...
q22_MediumVorteilAlter <- JoinTableAlter(q22_MediumVorteil)
...
q22_MediumVorteilGeschlecht <- JoinTableGeschlecht(q22_MediumVorteil)
